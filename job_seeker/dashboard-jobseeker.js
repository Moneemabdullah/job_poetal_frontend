...
const renderApplications = (applications) => {
  ...
  applications.forEach((application) => {
    ...
    document
      .getElementById(`details-application-btn-${application.id}`)
      .addEventListener("click", () => showDetailsPage(application.id));
    document
      .getElementById(`edit-application-btn-${application.id}`)
      .addEventListener("click", () => showEditPage(application.id));
    document
      .getElementById(`delete-application-btn-${application.id}`)
