document.addEventListener("DOMContentLoaded", function () {
  ...
  const profileUrl = "https://job-protal-api.onrender.com/job_seekers/profile/";
  const updateUrl =
    "https://job-protal-api.onrender.com/job_seekers/profile/edit/";
  ...
  async function fetchProfile() {
    try {
      ...
      profileElements.username.textContent =
        data.user || "No username available"; // Set username
      profileElements.about.textContent =
        data.about || "No information available";
      profileElements.resumeDownload.href = data.resume || "#";
      profileElements.resumeDownload.textContent = data.resume
        ? "Download Resume"
        : "No Resume Available";
      profileElements.education.textContent =
        data.education || "No education information available";
      profileElements.experiences.textContent =
        data.experiences || "No experience information available";
      profileElements.skills.textContent =
        data.skills || "No skills information available";
      profileElements.address.textContent =
        data.address || "No address information available";
      profileElements.country.textContent =
        data.country || "No country information available";
