document.addEventListener("DOMContentLoaded", () => {
    ...
    fetch("https://job-protal-api.onrender.com/employers/profile/", {
      ...
      .then((data) => {
        ...
        document.querySelector("input[name='company_name']").value =
          data.company_name || "";
        document.querySelector("textarea[name='company_description']").value =
  ...
  const updateProfileData = (event) => {
    ...
    const updatedData = {
      ...
      company_description: document.querySelector(
        "textarea[name='company_description']"
      ).value,
      company_website: document.querySelector("input[name='company_website']")
        .value,
    };

    fetch("https://job-protal-api.onrender.com/employers/profile/edit/", {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Token ${token}`,
